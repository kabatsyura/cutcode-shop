        ...
        <div class="container">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4">
                                @foreach ($options as $option => $values)
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <select name="oprions[]" id="filter-item-1" class="form-select w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition">
            ...
            <section class="mt-16 xl:mt-24">
                ...
                <div class="products grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12">
                    @each('product.shared.product', $viewedProducts, 'item')
                </div>
            </section>
        </div>
    </main>
